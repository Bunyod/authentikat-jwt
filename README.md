...
0.5.2
=====
Please update to 0.5.2 as soon as possible. Previous versions may be vulnerable to injection in cases where user controls values in the claims. 
...
Add the resolver and the dependency:
    ...
    libraryDependencies ++= Seq(
      "com.jason-goodwin" %% "authentikat-jwt" % "0.5.2"
    )
